...
if [ $VOLUME_ID ]; then
        ...
        sudo -H -u ubuntu bash -c "source /home/ubuntu/anaconda3/bin/actiavte tensorflow_p36 > output1.txt; python
        src/pre_proc.py > output2.txt; python src/Enc_Dec_LSTM.py > output3.txt"
